<script>
  ...
  <div class="w-[20%] border">
    <div class="flex-[2 1 0%] flex-col items-center p-4 gap-4">
        <input type="text" placeholder="Search Documents..." bind:value={searchQuery} class="w-full p-2 mb-4 rounded focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 text-xs transition-all duration-300 focus:scale-[1.02]" />
